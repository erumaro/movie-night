...
class TvOverviewPopular extends Component {
...
function mapDispatchToProps(dispatch){
	return bindActionCreators ({fetchPopularTV}, dispatch);
}

export default connect(mapStateToProps, mapDispatchToProps)(TvOverviewPopular);
