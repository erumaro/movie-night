...
class TvOverviewToprated extends Component {
...
function mapDispatchToProps(dispatch){
	return bindActionCreators ({fetchTopRatedTV}, dispatch);
}

export default connect(mapStateToProps, mapDispatchToProps)(TvOverviewToprated);
